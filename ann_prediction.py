...
from core import LocateIdx, Polygonal, Triangular, ROOTPATH, DROPLIST, df_source
...
model_dir = ROOTPATH + r'/Stock_CN/ml_model_data/ann_01.csv'
deep_columns = [
    coint_pvalue,
    ieas,
    pricetorevenue,
...
test_pred = estimator.predict(input_fn=pred_input_fn)
