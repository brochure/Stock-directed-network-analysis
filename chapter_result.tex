...
Second, according to the figure~\ref{subfig:std_return_weighted_centrality}, as the betweenness centrality of nodes become higher, there will be a higher possibility of nodes tend to have low standard deviation of stock daily return (SDR). The average SDRs for all values of betweenness centrality remain similar because of the more frequent occurrence of outliers with higher betweenness centralities from the figure.
